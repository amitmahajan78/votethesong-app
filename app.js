...
var vote_endpoint =
  "https://mlfa0fbvg2.execute-api.eu-west-2.amazonaws.com/dev/song/vote";
var get_votes_endpoint =
  "https://mlfa0fbvg2.execute-api.eu-west-2.amazonaws.com/dev/votes";
...
async function refreshVoteCounts() {
  ...
  for (i = 0; i < songs.length; i++) {
    var featured_songs = ["kabirsingh", "iktara", "humdard", "kaipoche"];
    var song = songs[i];
...
async function voteForSong(songName) {
  ...
  setVotes(songName, result_json["votes"]["N"]);
}
